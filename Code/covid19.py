...
def main():
    ...
    df_income = pd.read_csv(r'../Datasets/incomelandkreis.csv')  
    ...
    df_covid = pd.read_json(r'../Datasets/covid.json')
    ...
    df_area = pd.read_csv(r'../Datasets/Area.csv')  
    ...
    df_agegroup = pd.read_csv(r'../Datasets/Agegroup.csv') 
    ...
    df.to_csv('../Datasets/CovidDataSet.csv', header=True, index=False, encoding='utf-8')
    df_ref.to_csv('../Datasets/Landkreis.csv', header=True, index=False, encoding='utf-8')
...
# plot the heatmap
    ...
    fig.savefig(plot_path + "/HeatMap.png")
