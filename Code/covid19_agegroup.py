...
def main():
    ...
    df_covid = pd.read_csv(r'../Datasets/RKI_COVID19.csv')  
    ...
    df.pop('index')
    df.to_csv('../Datasets/AgegroupCovidDataSet.csv', header=True, index=False, encoding='utf-8')
    ...
    fig.savefig(plot_path+"/AgegroupHeatMap.png")
