...
df= pd.read_csv(r'../Datasets/RKI_COVID19.csv')  
df_covid = pd.read_csv(r'../Datasets/CovidDataSet.csv')
...
df_covid.to_csv('../Datasets/DaySeriesCovidDataSetAgegroup.csv', header=True, index=False, encoding='utf-8')
