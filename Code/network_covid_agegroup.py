...
def main():
    ...
    df=pd.read_csv('../Datasets/AgegroupCovidDataSet.csv')
    ...
    model.add(keras.layers.Dense(100,activation='elu',input_dim=5,kernel_initializer='normal',kernel_constraint=max_norm(5)))
